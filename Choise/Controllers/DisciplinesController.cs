...
namespace Choise.Controllers
{
    public class DisciplinesController : Controller
    {
        ...
        public DisciplinesController(ChoiseDbContext context)
        {
            _context = context;
        }
        ...
        {
            var choiseDbContext = _context.Disciplines.Include(d => d.Teacher);
            return View(await choiseDbContext.ToListAsync());
        }
